...
A ComfyUI node that uses Claude to generate optimized prompts for 30+ image and video models. 41 built-in templates for FLUX, Runway, Kling, Veo, Wan, Luma, Seedance, Qwen, Nano Banana, Sora, GPT Image 2, and others. Save your own templates, track every run with searchable execution history, and monitor costs.
...
- **41 built-in templates**: pre-written instructions for popular AI video/image models (generation and editing)
