...
## Model Specs
Nano Banana 2 is built on Gemini 3.1 Flash, a speed-optimized model that generates images in under 20 seconds. It supports extended aspect ratios (including ultra-wide 1:8 and 8:1), Google Search Grounding with both text and image search, and can reference up to 14 images (10 objects + 4 characters) in a single prompt.

### Tiers
- **Nano Banana 2** (Gemini 3.1 Flash Image): full Flash tier, generation under 20 seconds, resolution tiers up to 4K.
- **Nano Banana 2 Lite** (`gemini-3.1-flash-lite-image`): lighter tier, generally available June 30 2026, ~4 second generation, 1K-resolution tier, ~$0.034 per image. Suited to high-volume, latency-sensitive workflows.
...
- Text rendering: legible, stylized text for posters, infographics, menus
...
- Speed-optimized for iteration and high-volume workflows
...
## Special Features
- **Speed**: under 20 seconds per generation, suited to rapid iteration and high-volume workflows
- **Search Grounding**: add "using current real-world reference" for factual imagery of specific brands, landmarks, current events, using both web and image search
...
## Limitations
- Character consistency works best with the 360-degree character sheet approach; not fully reliable without it
