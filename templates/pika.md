...
- **Pikaffects**: special-effects presets (Inflate, Explode, Crush, Melt, Cakeify, Levitate, etc.)
...
## Negative Prompts
Always include. Keep it to 3-5 focused terms. Default baseline:
```
blurry, low quality, watermark, distorted, morphing
```

Swap terms in per content (stay within 3-5 total):
- Faces: "deformed face, extra fingers, low quality"
- Products: "label distortion, warped text, color shift"
- Landscapes: "floating objects, warped horizon, low quality"
